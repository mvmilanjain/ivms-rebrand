...
const Request = (props) => {
    ...
    const renderActions = ({value}) => {
        return (
            <Menu withArrow size="sm" control={<ActionIcon variant="transparent"><DotsVerticalIcon/></ActionIcon>}>
                <Menu.Item icon={<EditIcon/>}>Edit Request</Menu.Item>
                <Menu.Item icon={<ViewIcon/>}>View Request</Menu.Item>
    ...
    const openDeleteConfirmModal = (routeId) => {
        modals.openConfirmModal({
            ...
            labels: {confirm: "Delete request", cancel: "No don't delete it"},
            ...
            onConfirm: () => {
                ...
                requestHandler(deleteOrder(routeId)).then(() => {
                    ...
                    notifications.showNotification({
                        ...
                        message: 'Not able to delete request. Something went wrong!!'
                    });
