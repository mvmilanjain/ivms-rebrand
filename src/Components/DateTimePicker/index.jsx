...
const DateTimePicker = forwardRef((
    ...
    const handleValueChange = (date) => {
        ...
        setValue(date);
        closeCalendarOnChange && setInputState(upperFirst(dayjs(date).locale(finalLocale).format(dateFormat)));
    ...
    return (
        ...
        >
            ...
            />
            <TimeInput
                mb="sm" icon={<ClockIcon/>}
                styles={{controls: {justifyContent: "center", marginLeft: -20}}}
                disabled={!_value} value={_value} onChange={handleTimeChange}
            />
            <Group position="apart" align="center">
                <Anchor component="button" color="blue" onClick={handleNow}>Now</Anchor>
                {!closeCalendarOnChange && <Button disabled={!_value} onClick={handleOk}>Ok</Button>}
            </Group>
        </DateTimePickerBase>
    );
});
